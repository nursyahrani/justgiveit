...
class DevAsset extends AssetBundle
{
    ...
    public $css = [
        ...
        'frontend/web/css/banner.css',
        'frontend/web/css/common-library.css',
        'frontend/web/css/confirmation-modal.css',
        ...
        'frontend/web/css/home-proposal-box.css',
        'frontend/web/css/search-bar.css',
        'frontend/web/css/banner-with-search.css',
        'frontend/web/css/post-card.css',
        'frontend/web/css/profile.css',
    ...
    public $js =  [
        ...
        'frontend/web/js/confirmation-modal.js',
